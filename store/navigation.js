...
export const state = () => ({
    tree: [
        ...
        { id: 6, label: 'projects', url: '/projects'},
        { id: 7, label: 'projects', url: '/projects'},
        { id: 8, label: 'projects', url: '/projects'},
        { id: 9, label: 'projects', url: '/projects'},
        { id: 10, label: 'projects', url: '/projects'},
    ],
});
